...
<div class="relative  items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="form">
            ...
            <form  method="POST" id="" action="{{ route('downloadfax_mobile') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <label for="">Choisir le type :</label>
                        <select name="phone_type" id="" required class="form-control">
                            <option value="" selected>-- Choisir le type de télèphone --</option>
